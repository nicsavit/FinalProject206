...
def covid_and_vaccine_visualization(cur, conn):
    ...
    plt.bar(ind, men_means, width, label='Average Covid Increase')
    plt.bar(ind + width, women_means, width,
    label='Average Vaccine Increase')
    plt.ylabel('Average Increase of Vaccines and Covid Cases Per Day')
    plt.title('Average Increase of Vaccines and Covid Cases Per Day by Location')
	plt.xticks(y_pos + width / 2, ([0,1,2,3], x))
    plt.legend(loc='best')
    plt.show()
